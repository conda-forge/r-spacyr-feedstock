...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-spacyr-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-spacyr-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-spacyr-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-spacyr-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-spacyr-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-spacyr-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-spacyr` can be installed with:

```
conda install r-spacyr
```

It is possible to list all of the versions of `r-spacyr` available on your platform with:
